...
data_x, data_y = loadlocal_mnist('./train-images.idx3-ubyte', './train-labels.idx1-ubyte')

index_3 = np.random.choice(np.where(data_y == 3)[0], size=n_samples, replace=False)
index_7 = np.random.choice(np.where(data_y == 7)[0], size=n_samples, replace=False)
